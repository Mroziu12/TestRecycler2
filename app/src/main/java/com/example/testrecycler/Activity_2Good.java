...
public class Activity_2Good extends AppCompatActivity implements MyWifiAdapter.OnCardWifiListener {
    String TAG = "Mroziu";
    ...
    TextView tvWybraneUrzadzenie, tvTopic, tvMessage, tvTopicPos, tvMessagePos;
    ImageView ivWarning, ivDone;

    BluetoothSocket pobranyBluetoothSocket = SocketHandler.getSocket();
    WiFiSearchDialog wiFiSearchDialog;
    WiFiCheckDialog wiFiCheckDialog;
    ...
    BroadcastReceiver wifiReciever = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            for (ScanResult scanResult : results) {
                ...
                MyWifiAdapter myWifiAdapter = new MyWifiAdapter(context1, results, Activity_2Good.this);
                recyclerView.setAdapter(myWifiAdapter);
                recyclerView.setLayoutManager(new LinearLayoutManager(context1));
            }
            wiFiSearchDialog.dismissWiFiSearchDialog();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2_good);
        ...
        wiFiSearchDialog = new WiFiSearchDialog(Activity_2Good.this);
        wiFiCheckDialog = new WiFiCheckDialog(Activity_2Good.this);
        ...
        scanWifi();
        wiFiSearchDialog.startWiFiSearchDialog();
...
//
    ...
    private void openActivity2() {
        Intent intent = new Intent(this, Activity_2Good.class);
        startActivity(intent);
    }

    private void PokazDialogPositive() {
        Log.d(TAG, "PokazDialogPos: przed set content");
        mDialogPos.setContentView(R.layout.dialog_check_pos);
