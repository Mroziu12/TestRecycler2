...
public class MyWifiAdapter extends RecyclerView.Adapter<MyWifiAdapter.MyViewHolder> {
    String TAG = "RecList";
    Context context;
    List<ScanResult> names;
    private OnCardWifiListener onCardWifiListener;

    public MyWifiAdapter(Context ct, List<ScanResult> name1, OnCardWifiListener onCardWifiListener){
        context=ct;
        names=name1;
