...
public class MainActivity extends AppCompatActivity implements MyAdapter.OnCardListener {
    ...
    BtSearchDialog btSearchDialog;
    BtConnectDialog btConnectDialog;

    Dialog mDialog;
    TextView tvWybraneUrzadzenie, tvTopic, tvMessage;
    ImageView ivWarning;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                if(device.getName()!=null){
                    ...
                    MyAdapter myAdapter = new MyAdapter(context1, mBTDevices,MainActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btSearchDialog= new BtSearchDialog(MainActivity.this);
        btConnectDialog= new BtConnectDialog(MainActivity.this);
...
//    }
    ...
    public void onCardClick(int position) {
        ...
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
            ...
            btConnectDialog.dismissBtConnectDialog();
